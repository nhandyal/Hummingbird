...
<html>
		<head>
				<title>Acount Settings | Hummingbird</title>
														...
														<div id='add-phone-content'>
																...
																<div id='verify-mobile-code' class='add-phone-form-element'>
																		<div style='margin-bottom:7px'>
																				Enter the Hummingbird mobile verification code in the space below. If you didn't receive a verification messages don't fret! Simply refresh the page and try again.
																		</div>
