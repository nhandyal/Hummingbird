<?php
		...
		$vrf_link = 'http://www.coursespot.net/application/register/verify-email.php?vrf-email='.$email_hash;
		$to = $email;
		$subject = "Welcome to Coursespot";
								...
								<table style='width:600px; margin:auto'>
										...
										<tr style='text-align:justify'>
												<td colspan='2' style='padding-top:20px'>
														Welcome to Coursespot. We hope you enjoy using this service as much as we enjoyed making it. Before you can get started, we just need to verify your account.
										...
										<tr style='text-align:center'>
												<td colspan='2'>
														A few things we want you to remember before using Coursespot.
												</td>
										</tr>
										<tr>
...
<html>
		<head>
				<meta charset="UTF-8"/>
				<title>Verify Email : Coursespot</title>
