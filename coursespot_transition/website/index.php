						...
						<div id="main-content-container">
								<div id="logo-container">
										<div id="hummingbird-holder">
												<span id="humming">COURSE</span><span id="bird">SPOT</span>
										</div>
										<div id='ui-elements'>
								...
								<div id="about-container">
										<p id="about-description"><span class="black">Course</span><span class="red">spot</span> is a USC course scheduling assistant designed with one goal, take the courses you want, when you want them.
										Its like having your own personal secretary. Coursespot continuously monitors the classes that you pick and as soon as they become available, guess whose the first to know?
										For those of you who have heard enough and want to get started, sign-up below. For the rest of you skeptics, keep reading to find out how Coursespot works!</p>
								</div>
								...
								<div id="faq-container">
										...
										<ul id="faq-elements">
												<li>Coursespot is currently designed to only work with USC's schedule of classes. If you don't go to USC, try it out anyway. After you fall in love with it get in touch with us and we'll see if we can bring Coursespot to your school!</li>
												<li>Remember before Coursespot when you used to check course availability every 5 minutes? Yeah..., Those guys are still out there. So while Coursespot can give you a heads up on when a class is open, you still have to go register for it.</li>
								...
								<div id="contact-container">
										...
										<p id="contact-header">We would love to hear from you. Tell us if something is broken, a feature you'd like to see, any trouble you're have using Coursespot, or if you would just like to say Hi. If you love Coursespot, spread the word by telling all your friends about how awesome we are.</p>
